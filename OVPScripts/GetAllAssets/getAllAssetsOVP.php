...
//$argv[1]=partnerId
//$argv[2]=adminSecret
//$argv[3]=endDateGreaterThanOrEqual - criteria to restrict the results to 10000
//$argv[4]=endDateLessThanOrEqual- criteria to restrict the results to 10000
...
$partnerId = $argv[1];
$adminSecret = $argv[2];
$endDateGreaterThanOrEqual = $argv[3];
$endDateLessThanOrEqual = $argv[4];
$fileName = $argv[5];
...
$filter->endDateGreaterThanOrEqual = $endDateGreaterThanOrEqual;
$filter->endDateLessThanOrEqual = $endDateLessThanOrEqual;
