...
// Usage php patchRoleIds.php <AdminKS> userIdTest 2
// This script will call /ottUser/action/update and update the RoleIds according to the 3rd Param
...
$roleIds = $argv[3]; // RoleIds to be assigned to the user. 
...
if (file_exists($userIdList)) {
    ...
    foreach ($userIdRows as $userId) {
        ...
        curl_setopt_array($curl, array(
          CURLOPT_URL => "https://rest-as.ott.kaltura.com/v4_7/api_v3/service/ottUser/action/update",
